            ...
            <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
              {isConfigured ? (
                ...
                <div className="flex min-h-[60vh] items-center justify-center">
                  <div className="max-w-lg rounded-2xl border border-amber-200 bg-amber-50 p-8 text-center dark:border-amber-900 dark:bg-amber-950">
                    <h1 className="mb-2 text-2xl font-bold text-amber-800 dark:text-amber-200">
                      ⚙️ Supabase Setup Required
                    </h1>
                    <p className="mb-4 text-amber-700 dark:text-amber-300">
                      Database is not configured yet. Follow these steps:
                    </p>
                    <div className="rounded-lg bg-white p-4 text-left text-sm text-slate-700 dark:bg-slate-900 dark:text-slate-300">
                      ...
                      <p className="mb-2 font-semibold">2. Run <code className="rounded bg-slate-100 px-1.5 py-0.5 text-xs dark:bg-slate-800">supabase/schema.sql</code> in Supabase SQL Editor</p>
