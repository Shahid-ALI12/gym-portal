-- ============================================================
-- Gym Portal — RLS FIX (Run this in Supabase SQL Editor)
-- ============================================================
-- Ye script saari existing policies DROP karti hai aur
-- fresh permissive policies lagati hai. Guarantee ke saath
-- INSERT/UPDATE/DELETE/SELECT sab chalega.
-- ============================================================
...
-- DONE. Ab plans add karo, error nahi aayega.
